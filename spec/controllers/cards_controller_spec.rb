...
describe CardsController do
  ...
  let(:valid_attributes) { { "card_id" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved card as @card" do
        ...
        post :create, {:card => { "card_id" => "invalid value" }}, valid_session
        assigns(:card).should be_a_new(Card)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested card" do
        ...
        Card.any_instance.should_receive(:update).with({ "card_id" => "MyString" })
        put :update, {:id => card.to_param, :card => { "card_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the card as @card" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Card.any_instance.stub(:save).and_return(false)
        put :update, {:id => card.to_param, :card => { "card_id" => "invalid value" }}, valid_session
        assigns(:card).should eq(card)
      end
